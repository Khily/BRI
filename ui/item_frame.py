...
class ItemFrame(customtkinter.CTkFrame):
    ...
    def create_widgets(self):
        ...
        customtkinter.CTkLabel(self, text="Category", font=customtkinter.CTkFont(family="Poppins", size=24, weight="bold"), text_color="gray10").grid(row=1, column=0, sticky="w", padx=25)
        ...
        self.item_list_title = customtkinter.CTkLabel(self, text="Semua Barang", font=customtkinter.CTkFont(family="Poppins",size=24, weight="bold"), text_color="gray10")
    ...
    def create_category_button(self, parent, text, command):
        ...
        button = customtkinter.CTkButton(parent, text=text, font=("Inter", 14, "bold"), command=command,
                                         height=40, corner_radius=8, fg_color="#0E69B0",
    ...
    def select_category_button(self, selected_button):
        ...
        for btn in self.category_buttons:
            ...
            btn.configure(fg_color="#0E69B0" if is_selected else "#F1F5F9",
