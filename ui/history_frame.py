...
class HistoryFrame(customtkinter.CTkFrame):
    ...
    def create_widgets(self):
        ...
        filter_container.grid(row=0, column=1, sticky="e", padx=(0, 30))
        ...
        apply_button = customtkinter.CTkButton(filter_container, text="Filter", command=self.refresh_history_table, height=40, fg_color="#E5E7EB", text_color="#374151", hover_color="#D1D5DB")
        ...
        reset_button.pack(side="left", padx=(0, 70))

        export_button = customtkinter.CTkButton(filter_container, text="Export ke Excel", command=self.export_to_excel, height=40, fg_color="#1D8023")
