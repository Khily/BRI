...
class ManagementFrame(customtkinter.CTkFrame):
    ...
    def create_widgets(self):
        ...
        add_item_button = customtkinter.CTkButton(action_button_frame, text="+ Tambah Barang", command=self.add_item_popup, text_color="#FFFFFF")
        add_item_button.pack(side="left", padx=10)
        
        add_category_button = customtkinter.CTkButton(action_button_frame, text="+ Tambah Kategori", command=self.add_category_popup, text_color="#FFFFFF")
        ...
        customtkinter.CTkLabel(admin_text_frame, text="Halo", font=("Poppins", 15)).pack(anchor="e")
        customtkinter.CTkLabel(admin_text_frame, text="Super Admin", font=("Poppins", 15, "bold"), text_color="gray50").pack(anchor="e")
